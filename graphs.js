...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    socket.emit("loadCA", { run: "actualRuns", "params.healPoisonRange": .33});
...
function drawData(obj, runs, ctx) {
    ...
    drawHistogram(ctx, 600, obj.histogramCell, "Cell Genome");
	drawHistogram(ctx, 720, obj.histogramHealPoi, "Heal Poison");
